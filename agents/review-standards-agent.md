---
name: review-standards-agent
description: Checks changed files against the project's visible coding conventions and guidelines, the "Standards" axis of the /review skill's two-axis code review. Never dispatched directly by the user.
tools:
  - Read
  - Grep
  - Glob
