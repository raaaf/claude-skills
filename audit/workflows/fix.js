...
//
// Same Workflow-Kontrakt as find.js (audit/references/finding-schema.md): agent()
// returns the schema-validated object, parallel() returns null for a failed slot,
// resumeFromRunId replays cached agents.

import { warnIfNull } from './lib.js';

export const meta = {
  phases: ['Fix', 'Verify', 'Regress']
};
