...
- **Deliver something, always, and inside your budget.** You have at most 30 tool calls (raised
  from 20 when the dimension workers were collapsed: a multi-dimension worker reads up to 3
  dimension modules and up to 5 guidelines on top of its files — see `w1-code.md`/`w3-frontend.md`/
